    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == sendButton || e.getSource() == chatTextField){
            ...
            if (message.contains("view") || message.contains("booked") || message.contains("track")) {
                ...
                this.chatTextArea.append("Support: To book a flight, first navigate to the dashboard by clicking the back button if you aren't already there. Then, choose the Book Flight option in the navigation pane. You should then be able to pick a flight from the list, and book it after viewing more detailed information about the flight in the bottom right corner.\n\n");
            } else {
